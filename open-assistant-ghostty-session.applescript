...
# @raycast.title Open assistant Ghostty Session
...
on run argv
    set projectDir to "~/Development/assistant"
    ...
    tell application "System Events"
        tell process "Ghostty"
            ...
            -- Change to the assistant project
